...
/**
 * PoliklinikSearch represents the model behind the search form of `frontend\models\Poliklinik`.
 */
class PoliklinikSearch extends Poliklinik
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'registrasilama' => $this->registrasilama,
        ]);

        $query->andFilterWhere(['like', 'kd_poli', $this->kd_poli])
            ->andFilterWhere(['like', 'nm_poli', $this->nm_poli])
